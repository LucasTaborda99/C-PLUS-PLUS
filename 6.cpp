...
int main(){
	...
	cout << "\nNúmero 1: " << n1 << " vezes" << " ou " << (n1 / 100000.0 * 100) << " % das vezes";
	cout << "\nNúmero 2: " << n2 << " vezes" << " ou " << (n2 / 100000.0 * 100) << " % das vezes";
	cout << "\nNúmero 3: " << n3 << " vezes" << " ou " << (n3 / 100000.0 * 100) << " % das vezes";
	cout << "\nNúmero 4: " << n4 << " vezes" << " ou " << (n4 / 100000.0 * 100) << " % das vezes";
	cout << "\nNúmero 5: " << n5 << " vezes" << " ou " << (n5 / 100000.0 * 100) << " % das vezes";
	cout << "\nNúmero 6: " << n6 << " vezes" << " ou " << (n6 / 100000.0 * 100) << " % das vezes" << endl;
